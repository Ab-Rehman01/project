...
const Footer: React.FC = () => {
  return (
    <footer className="text-white body-font bg-black"> {/* Change background and text color */}
      <div className="container px-5 py-20 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          {/* Category 1 */}
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">CATEGORIES</h2> {/* Change text color */}
            <nav className="list-none mb-10">
              <li>
                <a className="text-gray-300 hover:text-gray-400">First Link</a> {/* Change text color */}
              </li>
              <li>
      ...
      <div className="bg-gray-800"> {/* Change footer bottom background color */}
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-10 h-10 text-white p-2 bg-indigo-500 rounded-full" viewBox="0 0 24 24">
              <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
            </svg>
            <span className="ml-3 text-xl">A-Rehman</span>
          </a>
          <p className="text-gray-300 text-sm sm:ml-6 sm:mt-0 mt-4">© 2024 Portfolio —
